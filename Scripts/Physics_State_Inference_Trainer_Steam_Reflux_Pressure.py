...
def train(params,csv_name):
    ...
    print("Training SRP state model...")
    ...
    joblib.dump(model, "Models/SRP_predictor.pkl")
    joblib.dump(scaler_X, "Models/SRP_predictorX.pkl")
    joblib.dump(scaler_Y, "Models/SRP_predictorY.pkl")
