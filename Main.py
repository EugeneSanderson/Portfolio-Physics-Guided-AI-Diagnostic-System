...
N_SAMPLES = 100000                               #How many simulations to append to the dataset

# --=== Soft Sensors Neural Network Configs ===--

psitc_params = {"hidden_layer_sizes" : (8),                 # Composition Soft Sensors (Full Profile) Neural Network
                "activation":"relu",
                "max_iter":5000,
                "learning_rate":"adaptive",
                "verbose":True,
                "tol":0.000001}
psitfr_params = {"hidden_layer_sizes" : (8),                # Feed Rates Soft Sensors (Feed, Distillate, Bottoms) Neural Network
                "activation":"relu",
                "max_iter":5000,
                "learning_rate":"adaptive",
                "verbose":True,
                "tol":0.000001}
psitsrp_params = {"hidden_layer_sizes" : (8),               # Steam, Reflux, Column Pressure Soft Sensors Neural Network
                    "activation":"relu",
                    "max_iter":5000,
                    "learning_rate":"adaptive",
                    "verbose":True,
                    "tol":0.000001}
psitt_params = {"hidden_layer_sizes" : (8),                 # Temperature Soft Sensors (Full Profile) Neural Network
                "activation":"relu",
                "max_iter":5000,
                "learning_rate":"adaptive",
                "verbose":True,
...
tst_params = {"hidden_layer_sizes" : (64,32,16),                   # True State Profiler Neural Network
                "activation":"relu",
                "max_iter":5000,
                "learning_rate":"adaptive",
                "verbose":True,
...
nntftl_params = {"hidden_layer_sizes" : (64,32,16),                # Fault detector Neural Network
                "activation":"relu",
                "max_iter":5000,
                "learning_rate":"adaptive",
                "verbose":True,
